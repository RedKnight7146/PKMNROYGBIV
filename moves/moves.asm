...
; Characteristics of each move.
	...
	move RAZOR_WIND,   CHARGE_EFFECT,               80, FLYING,        85, 10
	...
	move FAKE_TEARS,   SPECIAL_DOWN2_EFFECT,	 0, NORMAL,	   85, 20
	move SCARY_FACE,   SPEED_DOWN2_EFFECT,		 0, NORMAL,	  100, 20
	move CHARM,	   ATTACK_DOWN2_EFFECT,		 0, NORMAL,	  100, 20
	move CONFIDE,      SPECIAL_DOWN1_EFFECT,	 0, NORMAL,	  100, 20
	move FORCE_PALM,   PARALYZE_SIDE_EFFECT2,	65, FIGHTING,	  100, 20
	...
	move POWDER_SNOW,  FREEZE_SIDE_EFFECT,		40, ICE,	  100, 40
	move MEGAHORN,	   NO_ADDITIONAL_EFFECT,       120, BUG,	   85,  5
	move TWISTER, 	   FLINCH_SIDE_EFFECT2,		40, DRAGON,       100, 20
	move OUTRAGE,	   THRASH_PETAL_DANCE_EFFECT,  100, DRAGON,	  100, 15
	move SEED_BOMB,    NO_ADDITIONAL_EFFECT,	80, GRASS,	  100, 15
	move DIVE,         FLY_EFFECT,			70, WATER,	  100, 10
	move PHANTOMFORCE, FLY_EFFECT,			90, GHOST,	  100, 10
	move MACH_PUNCH,   NO_ADDITIONAL_EFFECT,	40, FIGHTING,	  100, 30
	move POWER_WHIP,   NO_ADDITIONAL_EFFECT,       120, GRASS,	   80,  5
	move LEAF_BLADE,   NO_ADDITIONAL_EFFECT,	70, GRASS,	  100, 10
	move BLAZE_KICK,   NO_ADDITIONAL_EFFECT,	85, FIRE,	   90, 10
	move MUDDY_WATER,  NO_ADDITIONAL_EFFECT,	95, WATER,	   85, 10
	move SKY_UPPERCUT, NO_ADDITIONAL_EFFECT,	85, FIGHTING,      90, 15
