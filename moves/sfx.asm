MoveSoundTable:
	...
	db SFX_NOT_VERY_EFFECTIVE, $10, $ff ; SHADOW_CLAW
	db SFX_PSYBEAM,            $50, $b0 ; SHADOW_BALL
	db SFX_DAMAGE,             $10, $90 ; AERIAL_ACE
	db SFX_BATTLE_24,          $80, $d0 ; GIGA_DRAIN
	db SFX_BATTLE_24,          $60, $90 ; DRAIN_PUNCH
	db SFX_BATTLE_09,          $00, $40 ; FAKE_TEARS
	db SFX_NOT_VERY_EFFECTIVE, $00, $ff ; SCARY_FACE
	db SFX_BATTLE_24,          $20, $30 ; CHARM
	db SFX_BATTLE_24,          $10, $a0 ; CONFIDE
	db SFX_BATTLE_26,          $10, $40 ; FORCE_PALM
	db SFX_BATTLE_0D,          $90, $60 ; SHADOW_PUNCH
	db SFX_SUPER_EFFECTIVE,    $80, $80 ; X_SCISSOR
	db SFX_PSYBEAM,            $00, $40 ; SIGNAL_BEAM
	db SFX_BATTLE_29,          $30, $40 ; POWDER_SNOW
	db SFX_BATTLE_1E,          $70, $c0 ; MEGAHORN
	db SFX_BATTLE_12,          $10, $f0 ; TWISTER
	db SFX_BATTLE_22,          $71, $c0 ; OUTRAGE
	db SFX_BATTLE_34,          $00, $20 ; SEED_BOMB
	db SFX_FAINT_FALL,         $20, $20 ; DIVE
	db SFX_PSYCHIC_M,          $d0, $d0 ; PHANTOMFORCE
	db SFX_BATTLE_25,          $00, $10 ; MACH_PUNCH
	db SFX_VINE_WHIP,          $81, $80 ; POWER_WHIP
	db SFX_BATTLE_12,          $30, $c0 ; LEAF_BLADE
	db SFX_BATTLE_0D,          $10, $66 ; BLAZE_KICK
	db SFX_BATTLE_25,          $7f, $a0 ; MUDDY_WATER
	db SFX_BATTLE_0D,          $10, $40 ; SKY_UPPERCUT
	db SFX_VINE_WHIP,          $ff, $ff ; FRENZY_PLANT
	db SFX_BATTLE_19,          $ff, $ff ; BLAST_BURN
	db SFX_BATTLE_2A,          $ff, $ff ; HYDRO_CANNON
